...
本项目基于 [copyangle/SS_tools](https://github.com/copyangle/SS_tools) 的鸭鸭图媒体内容保护思路、ComfyUI 节点实现和载荷处理能力进行二次整理与本地应用封装。感谢原作者 copyangle 及 SS_tools 项目提供的核心基础。

本仓库主要在原项目基础上补充了本地 Web 应用、Electron 桌面壳、FastAPI 后端、PyInstaller 打包流程、回归测试和使用文档。除非原项目另有说明，本项目的改动与分发不代表原作者对本项目用途、发布版本或使用行为作出背书。使用者应同时尊重原项目来源、开源精神以及本项目中的使用声明。
